...
def test_create_order_with_auth(api_client, registered_user, valid_ingredients):
...
def test_create_order_without_auth(api_client, valid_ingredients):
...
def test_create_order_without_ingredients(api_client, registered_user):
...
def test_create_order_invalid_hash(api_client, registered_user):
