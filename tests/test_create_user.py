...
def test_register_unique_user(api_client, unique_email):
...
def test_register_existing_user(api_client, registered_user):
    password = Helpers.generate_random_password()
    name = data.DEFAULT_USER_NAME
...
def test_register_missing_required_field(api_client, missing_field):
